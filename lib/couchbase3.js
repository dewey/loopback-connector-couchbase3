...
exports.initialize = function initializeDataSource(dataSource, callback) {
  ...
  if (settings.cluster.host == null) {
    debug('Cluster host settings missing; trying default');
    settings.cluster.host = 'couchbase://localhost';
  }
...
Couchbase.prototype.connect = function(callback) {
  ...
  promise = new Promise(function(resolve, reject) {
    self.cluster = new couchbase.Cluster(settings.cluster.host, settings.cluster.options);
    // Open bucket here.
